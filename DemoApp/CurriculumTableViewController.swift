...
//    func loadCurriculum(){
//        SDCurriculum.shared.getCoursesForSubject(subject: <#T##String#>, accessToken: SDConstants.Values.testToken, completion: <#T##([[String : Any]]) -> Void#>)
//    }
...
extension CurriculumTableViewController: UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate{
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        self.subjectField.text = self.subjectFields[row]
        self.fieldDropDown.isHidden = true
    }
