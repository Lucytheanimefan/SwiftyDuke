...
public class SDCurriculum: NSObject {
    ...
    public func getCoursesForSubject(subject:String, accessToken:String, error:@escaping () -> Void, completion:@escaping ([[String:Any]]) -> Void)
    {
        SDRequester.streamer.makeHTTPRequest(method: "GET", endpoint: "curriculum/courses/subject/\(subject.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)!)?access_token=\(accessToken)", headers: nil, body: nil) { (response) in
            ...
            let resp = json["ssr_get_courses_resp"] as? [String:Any],
                ...
                let subject = subjects["subject"] as? [String:Any],
                let courseSummaries = subject["course_summaries"] as? [String:Any],
    ...
    public func offeringDetailsForCourse(id:String, offerNumber:String, accessToken:String, error:@escaping () -> Void, completion:@escaping ([String:Any]) -> Void){
    ...
    public func curriculumValues(field:String, accessToken:String, error:@escaping () -> Void, completion:@escaping ([[String:Any]]) -> Void){
